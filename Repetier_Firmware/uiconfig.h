...
#define UI_DISPLAY_RS_PIN		16	// 63
#define UI_DISPLAY_RW_PIN		-1
#define UI_DISPLAY_ENABLE_PIN	17	// 65
#define UI_DISPLAY_D0_PIN		23	// 59
#define UI_DISPLAY_D1_PIN		25	// 64
#define UI_DISPLAY_D2_PIN		27	// 44
#define UI_DISPLAY_D3_PIN		29	// 66
#define UI_DISPLAY_D4_PIN		23	// Repeat of first 4
...
void uiInitKeys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(37,35); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
...
void uiCheckKeys(uint16_t &action) {
 ...
 UI_KEYS_CLICKENCODER_LOW_REV(37,35); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
 UI_KEYS_BUTTON_LOW(33,UI_ACTION_OK); // push button, connects gnd to pin
...
// UI_KEYS_BUTTON_LOW(6,UI_ACTION_PREVIOUS); // push button, connects gnd to pin
 UI_KEYS_BUTTON_LOW(31,UI_ACTION_BACK); // push button, connects gnd to pin
